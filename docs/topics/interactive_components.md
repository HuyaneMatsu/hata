...
This topic is a continuation of the [slash](slash.md) one, so if you did not read that yet please go ahead.

Writing component based interactions is usually three times longer than writing generic ones, the components have to
be created and then handled when a user interacts with them.
So if writing some extra code is not your bread I do not recommend using components, although I never said they are
more complicated.
...
from hata import BUILTIN_EMOJIS, ButtonStyle, create_buutton
...
![](assets/interactive_components_0000.gif)
...
```py3
from hata import BUILTIN_EMOJIS, ButtonStyle, Emoji, create_button
from hata.ext.slash import InteractionResponse
...
![](assets/interactive_components_0001.gif)
...
```py3
import re
from hata import Role, create_button, create_row
...
```py3
from hata import Embed, BUILTIN_EMOJIS, ButtonStyle, create_button, create_row
from hata.ext.slash import InteractionResponse
...
![](assets/interactive_components_0002.gif)
...
```py3
from hata import BUILTIN_EMOJIS, Embed, DATETIME_FORMAT_CODE, create_button, elapsed_time
from hata.ext.slash import InteractionResponse
...
![](assets/interactive_components_0003.gif)
...
from hata import ButtonStyle, Emoji, Embed, create_button
from hata.ext.slash import InteractionResponse
...
![](assets/interactive_components_0004.gif)
...
```py3
import functools
from hata import ButtonStyle, Embed, create_button, create_row, parse_emoji
...
![](assets/interactive_components_0005.gif)
...
```py3
import functools
from hata import ButtonStyle, create_button
from hata.ext.slash import InteractionResponse, iter_component_interactions
...
![](assets/interactive_components_0007.gif)

And advantage of select over generic choices might be, that you cna allow the user to select non, or multiple options.

```py3
import functools
from hata import BUILTIN_EMOJIS, StringSelectOption, create_string_select
from hata.ext.slash import InteractionResponse, wait_for_component_interaction
...
![](assets/interactive_components_0006.gif)

----

<p align="left">
    <a href="./content_components.md">Previously: Content components</a>
</p>
