# -*- coding: utf-8 -*-
import re, string, zlib
from collections import namedtuple

from .dereaddons_local import multidict_titled

from .py_exceptions import ContentEncodingError,PayloadError
from .py_streams import StreamReader, EMPTY_PAYLOAD
from .py_url import URL
from .py_hdrs import SEC_WEBSOCKET_KEY1, CONTENT_LENGTH, METH_CONNECT, CONNECTION, CONTENT_ENCODING, TRANSFER_ENCODING
