...
# the key should contain an information about used proxy / TLS to prevent reusing wrong connections from a pool
...
class ClientRequest(object):
    ...
    def __init__(self, loop, method, url, headers=None, data=None, params=None, cookies=None, auth=None,
            proxy_url=None, proxy_auth=None, ssl=None):
