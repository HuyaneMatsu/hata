...
def test__ActivityAssets__copy_with__all_fields():
    ...
    activity_assets = ActivityAssets(
        image_invite_cover = old_image_invite_cover,
    ...
    copy = activity_assets.copy_with(
        image_invite_cover = new_image_invite_cover,
    ...
    vampytest.assert_eq(copy.image_invite_cover, new_image_invite_cover)
