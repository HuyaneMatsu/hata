...
from ..fields import put_buttons
...
def test__put_buttons(input_value, defaults):
    """
    Tests whether ``put_buttons`` is working as intended.
    ...
    """
    return put_buttons(input_value, {}, defaults)
