...
from ..fields import put_hang_type
...
def test__put_hang_type(input_value, defaults):
    """
    Tests whether ``put_hang_type`` is working as intended.
    ...
    """
    return put_hang_type(input_value, {}, defaults)
