...
from ..fields import put_secrets
...
def test__put_secrets(input_value, defaults):
    """
    Tests whether ``put_secrets`` is working as intended.
    ...
    """
    return put_secrets(input_value, {}, defaults)
