...
from ..fields import put_timestamps
...
def test__put_timestamps(input_value, defaults):
    """
    Tests whether ``put_timestamps`` is working as intended.
    Parameters
    ----------
    ...
    """
    return put_timestamps(input_value, {}, defaults)
