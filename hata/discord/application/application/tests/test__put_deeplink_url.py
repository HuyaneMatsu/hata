...
from ..fields import put_deeplink_url
...
def test__put_deeplink_url(input_value, defaults):
    """
    Tests whether ``put_deeplink_url`` is working as intended.
    ...
    """
    return put_deeplink_url(input_value, {}, defaults)
