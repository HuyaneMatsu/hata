...
from ..fields import put_discovery_eligibility_flags_into
...
def test__put_discovery_eligibility_flags_into(input_value, defaults):
    """
    Tests whether ``put_discovery_eligibility_flags_into`` is working as intended.
    ...
    """
    return put_discovery_eligibility_flags_into(input_value, {}, defaults)
