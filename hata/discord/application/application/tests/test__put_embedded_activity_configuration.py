...
from ..fields import put_embedded_activity_configuration
...
def test__put_embedded_activity_configuration(input_value, defaults):
    """
    Tests whether ``put_embedded_activity_configuration`` works as intended.
    ...
    """
    return put_embedded_activity_configuration(input_value, {}, defaults)
