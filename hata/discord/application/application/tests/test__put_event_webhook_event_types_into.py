...
from ..fields import put_event_webhook_event_types_into
...
def test__put_event_webhook_event_types_into(input_value, defaults):
    """
    Tests whether ``put_event_webhook_event_types_into`` is working as intended.
    ...
    """
    return put_event_webhook_event_types_into(input_value, {}, defaults)
