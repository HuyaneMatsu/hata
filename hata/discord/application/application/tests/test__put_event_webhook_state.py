...
from ..fields import put_event_webhook_state
...
def test__put_event_webhook_state(input_value, defaults):
    """
    Tests whether ``put_event_webhook_state`` is working as intended.
    ...
    """
    return put_event_webhook_state(input_value, {}, defaults)
