...
from ..fields import put_integration_types_configuration
...
def test__put_integration_types_configuration(input_value, defaults):
    """
    Tests whether ``put_integration_types_configuration`` is working as intended.
    ...
    """
    return put_integration_types_configuration(input_value, {}, defaults)
