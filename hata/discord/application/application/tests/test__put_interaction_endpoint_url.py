...
from ..fields import put_interaction_endpoint_url
...
def test__put_interaction_endpoint_url(input_value, defaults):
    """
    Tests whether ``put_interaction_endpoint_url`` works as intended.
    ...
    """
    return put_interaction_endpoint_url(input_value, {}, defaults)
