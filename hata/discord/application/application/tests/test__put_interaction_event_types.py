...
from ..fields import put_interaction_event_types
...
def test__put_interaction_event_types(input_value, defaults):
    """
    Tests whether ``put_interaction_event_types`` is working as intended.
    ...
    """
    return put_interaction_event_types(input_value, {}, defaults)
