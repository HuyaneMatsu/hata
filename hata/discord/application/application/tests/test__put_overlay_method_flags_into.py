...
from ..fields import put_overlay_method_flags_into
...
def test__put_overlay_method_flags_into(input_value, defaults):
    """
    Tests whether ``put_overlay_method_flags_into`` is working as intended.
    ...
    """
    return put_overlay_method_flags_into(input_value, {}, defaults)
