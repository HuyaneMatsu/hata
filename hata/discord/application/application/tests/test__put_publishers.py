...
from ..fields import put_publishers
...
def test__put_publishers(input_value, defaults):
    """
    Tests whether ``put_publishers`` works as intended.
    ...
    """
    return put_publishers(input_value, {}, defaults, include_internals = True)
