...
from ..fields import put_role_connection_verification_url
...
def test__put_role_connection_verification_url(input_value, defaults):
    """
    Tests whether ``put_role_connection_verification_url`` is working as intended.
    ...
    """
    return put_role_connection_verification_url(input_value, {}, defaults)
