...
from ..fields import validate_monetization_state
...
def test__validate_monetization_state(input_value):
    """
    Tests whether ``validate_monetization_state`` works as intended.
    ...
    TypeError
    """
    output = validate_monetization_state(input_value)
