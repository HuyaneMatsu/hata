...
from ..fields import put_release_phase
...
def test__put_release_phase(input_value, defaults):
    """
    Tests whether ``put_release_phase`` is working as intended.
    ...
    """
    return put_release_phase(input_value, {}, defaults)
