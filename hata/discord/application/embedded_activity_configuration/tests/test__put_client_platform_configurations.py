...
from ..fields import put_client_platform_configurations
...
def test__put_client_platform_configurations(input_value, defaults):
    """
    Tests whether ``put_client_platform_configurations`` works as intended.
    ...
    """
    return put_client_platform_configurations(input_value, {}, defaults)
