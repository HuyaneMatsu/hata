...
from ..fields import put_default_orientation_lock_state
...
def test__put_default_orientation_lock_state(input_value, defaults):
    """
    Tests whether ``put_default_orientation_lock_state`` is working as intended.
    ...
    """
    return put_default_orientation_lock_state(input_value, {}, defaults)
