...
from ..fields import put_default_tablet_orientation_lock_state_into
...
def test__put_default_tablet_orientation_lock_state_into(input_value, defaults):
    """
    Tests whether ``put_default_tablet_orientation_lock_state_into`` is working as intended.
    ...
    """
    return put_default_tablet_orientation_lock_state_into(input_value, {}, defaults)
