...
from ..fields import put_preview_video_asset_id_into
...
def test__put_preview_video_asset_id_into(input_value, defaults):
    """
    Tests whether ``put_preview_video_asset_id_into`` works as intended.
    ...
    """
    return put_preview_video_asset_id_into(input_value, {}, defaults)
