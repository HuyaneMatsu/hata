...
from ..fields import validate_default_tablet_orientation_lock_state
...
def test__validate_default_tablet_orientation_lock_state(input_value):
    """
    Tests whether ``validate_default_tablet_orientation_lock_state`` works as intended.
    ...
    TypeError
    """
    output = validate_default_tablet_orientation_lock_state(input_value)
