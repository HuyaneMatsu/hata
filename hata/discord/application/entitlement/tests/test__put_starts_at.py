...
from ..fields import put_starts_at
...
def test__put_starts_at(input_value, defaults):
    """
    Tests whether ``put_starts_at`` works as intended.
    ...
    """
    return put_starts_at(input_value, {}, defaults)
