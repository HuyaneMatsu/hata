...
from ..fields import put_subscription_id_into
...
def test__put_subscription_id_into(subscription_id, defaults):
    """
    Tests whether ``put_subscription_id_into`` works as intended.
    ...
    """
    return put_subscription_id_into(subscription_id, {}, defaults)
