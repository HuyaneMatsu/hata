...
from ..fields import put_release_at
...
def test__put_release_at(input_value, defaults):
    """
    Tests whether ``put_release_at`` works as intended.
    ...
    """
    return put_release_at(input_value, {}, defaults)
