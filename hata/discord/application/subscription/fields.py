...
put_cancelled_at_into = nullable_date_time_optional_putter_factory('cancelled_at')
...
put_country_code_into = url_optional_putter_factory('country')
...
put_current_period_end_into = nullable_date_time_optional_putter_factory('current_period_end')
...
put_current_period_start_into = nullable_date_time_optional_putter_factory('current_period_start')
...
put_entitlement_ids_into = optional_entity_id_array_optional_putter_factory('entitlement_ids')
