...
from ..fields import put_cancelled_at_into
...
def test__put_cancelled_at_into(input_value, defaults):
    """
    Tests whether ``put_cancelled_at_into`` works as intended.
    ...
    """
    return put_cancelled_at_into(input_value, {}, defaults)
