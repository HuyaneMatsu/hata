...
from ..fields import put_current_period_end
...
def test__put_current_period_end(input_value, defaults):
    """
    Tests whether ``put_current_period_end`` works as intended.
    ...
    """
    return put_current_period_end(input_value, {}, defaults)
