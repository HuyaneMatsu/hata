...
from ..fields import put_current_period_start_into
...
def test__put_current_period_start_into(input_value, defaults):
    """
    Tests whether ``put_current_period_start_into`` works as intended.
    ...
    """
    return put_current_period_start_into(input_value, {}, defaults)
