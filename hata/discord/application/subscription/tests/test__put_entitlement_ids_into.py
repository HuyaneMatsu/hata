...
from ..fields import put_entitlement_ids_into
...
def test__put_entitlement_ids_into(input_value, defaults):
    """
    Tests whether ``put_entitlement_ids_into`` is working as intended.
    ...
    """
    return put_entitlement_ids_into(input_value, {}, defaults)
