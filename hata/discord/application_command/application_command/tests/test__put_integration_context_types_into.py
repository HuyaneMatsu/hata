...
from ..fields import put_integration_context_types_into
...
def test__put_integration_context_types_into(input_value, defaults):
    """
    Tests whether ``put_integration_context_types_into`` is working as intended.
    ...
    """
    return put_integration_context_types_into(input_value, {}, defaults)
