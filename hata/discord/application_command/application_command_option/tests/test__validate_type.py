...
def _iter_options():
    ...
    yield ApplicationCommandOptionType.string, ApplicationCommandOptionType.string
    yield ApplicationCommandOptionType.string.value, ApplicationCommandOptionType.string
