...
def test__ApplicationCommandOptionMetadataInteger__copy_with_keyword_parameters__0():
    """
    Tests whether ``ApplicationCommandOptionMetadataInteger.copy_with_keyword_parameters`` works as intended.
...
def test__ApplicationCommandOptionMetadataInteger__copy_with_keyword_parameters__1():
    """
    Tests whether ``ApplicationCommandOptionMetadataInteger.copy_with_keyword_parameters`` works as intended.
