...
def test__ApplicationCommandOptionMetadataNumeric__copy():
    """
    Tests whether ``ApplicationCommandOptionMetadataNumeric.copy`` works as intended.
    """
    required = True
    autocomplete = True
...
def test__ApplicationCommandOptionMetadataNumeric__copy_with__0():
    """
    Tests whether ``ApplicationCommandOptionMetadataNumeric.copy_with`` works as intended.
...
def test__ApplicationCommandOptionMetadataNumeric__copy_with__1():
    """
    Tests whether ``ApplicationCommandOptionMetadataNumeric.copy_with`` works as intended.
...
def test__ApplicationCommandOptionMetadataNumeric__copy_with_keyword_parameters__0():
    """
    Tests whether ``ApplicationCommandOptionMetadataNumeric.copy_with_keyword_parameters`` works as intended.
...
def test__ApplicationCommandOptionMetadataNumeric__copy_with_keyword_parameters__1():
    """
    Tests whether ``ApplicationCommandOptionMetadataNumeric.copy_with_keyword_parameters`` works as intended.
