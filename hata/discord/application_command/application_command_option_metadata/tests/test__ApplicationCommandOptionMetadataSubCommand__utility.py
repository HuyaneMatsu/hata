...
def test__ApplicationCommandOptionMetadataSubCommand__copy_with_keyword_parameters__0():
    """
    Tests whether ``ApplicationCommandOptionMetadataSubCommand.copy_with_keyword_parameters`` works as intended.
...
def test__ApplicationCommandOptionMetadataSubCommand__copy_with_keyword_parameters__1():
    """
    Tests whether ``ApplicationCommandOptionMetadataSubCommand.copy_with_keyword_parameters`` works as intended.
