...
from ..fields import put_application_commands_into
...
def test__put_application_commands_into(input_value, defaults):
    """
    Tests whether ``put_application_commands_into`` works as intended.
    ...
    """
    return put_application_commands_into(input_value, {}, defaults)
