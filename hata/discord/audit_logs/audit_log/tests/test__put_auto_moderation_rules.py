...
from ..fields import put_auto_moderation_rules
...
def test__put_auto_moderation_rules(input_value, defaults):
    """
    Tests whether ``put_auto_moderation_rules`` works as intended.
    ...
    """
    return put_auto_moderation_rules(input_value, {}, defaults)
