...
from ..fields import put_entries
...
def test__put_entries(input_value, defaults):
    """
    Tests whether ``put_entries`` works as intended.
    ...
    """
    return put_entries(input_value, {}, defaults)
