...
from ..fields import put_scheduled_events
...
def test__put_scheduled_events(input_value, defaults):
    """
    Tests whether ``put_scheduled_events`` works as intended.
    ...
    """
    return put_scheduled_events(input_value, {}, defaults)
