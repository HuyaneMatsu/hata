...
from ..fields import put_webhooks_into
...
def test__put_webhooks_into(input_value, defaults):
    """
    Tests whether ``put_webhooks_into`` works as intended.
    ...
    """
    return put_webhooks_into(input_value, {}, defaults)
