...
from ..audit_log_change.flags import get_flags_name
...
class AuditLogEntryChangeConversion(RichAttributeErrorBaseType):
    ...
    def __new__(cls, field_key, field_name, flags, *, get_converter = ..., put_converter = ..., validator = ...):
        """
    ...
    def __repr__(self):
        ...
        repr_parts.append(get_flags_name(self.flags))
