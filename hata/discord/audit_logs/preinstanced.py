...
from .change_converters.onboarding_prompt import ONBOARDING_PROMPT_CONVERTERS
from .change_converters.onboarding_screen import ONBOARDING_SCREEN_CONVERTERS
...
class AuditLogTargetType(PreinstancedBase):
    ...
    +-----------------------------------+-----------------------------------+-------+-------------------------------------------+
    | auto_moderation_action_execution  | auto moderation action execution  | 16    | USER_CONVERTERS                           |
    +-----------------------------------+-----------------------------------+-------+-------------------------------------------+
    | onboarding_screen                 | onboarding screen                 | 17    | ONBOARDING_SCREEN_CONVERTERS              |
    +-----------------------------------+-----------------------------------+-------+-------------------------------------------+
    | onboarding_prompt                 | onboarding prompt                 | 18    | ONBOARDING_PROMPT_CONVERTERS              |
    +-----------------------------------+-----------------------------------+-------+-------------------------------------------+
    """
    INSTANCES = {}
    VALUE_TYPE = int
    ...
    auto_moderation_action_execution = P(16, 'auto moderation action execution', target_converter_none, USER_CONVERTERS)
    onboarding_screen = P(17, 'onboarding screen', target_converter_none, ONBOARDING_SCREEN_CONVERTERS)
    onboarding_prompt = P(18, 'onboarding prompt', target_converter_none, ONBOARDING_PROMPT_CONVERTERS)
...
class AuditLogEvent(PreinstancedBase):
    ...
    auto_moderation_block_message = P(
        143, 'auto moderation block message', AuditLogTargetType.auto_moderation_action_execution
    )
    auto_moderation_alert_message = P(
        143, 'auto moderation alert message', AuditLogTargetType.auto_moderation_action_execution
    )
    auto_moderation_user_timeout = P(
        143, 'auto moderation user timeout', AuditLogTargetType.auto_moderation_action_execution
    )
    ...
    onboarding_prompt_create =  P(163,'onboarding prompt create', AuditLogTargetType.onboarding_prompt)
    onboarding_prompt_update =  P(164, 'onboarding prompt update', AuditLogTargetType.onboarding_prompt)
    onboarding_prompt_delete = P(165, 'onboarding prompt delete', AuditLogTargetType.onboarding_prompt)
    
    onboarding_screen_create =  P(166,'onboarding screen create', AuditLogTargetType.onboarding_screen)
    onboarding_screen_update =  P(167, 'onboarding screen update', AuditLogTargetType.onboarding_screen)
