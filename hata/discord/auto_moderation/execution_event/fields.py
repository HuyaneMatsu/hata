...
put_action = entity_putter_factory('action', AutoModerationAction)
...
put_alert_system_message_id = entity_id_optional_putter_factory('alert_system_message_id')
...
put_matched_content = nullable_string_putter_factory('matched_content')
...
put_matched_keyword = nullable_string_putter_factory('matched_keyword')
...
put_rule_id = entity_id_optional_putter_factory('rule_id')
...
put_rule_trigger_type = preinstanced_putter_factory('rule_trigger_type')
