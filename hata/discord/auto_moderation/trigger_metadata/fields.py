...
put_excluded_keywords = nullable_string_array_optional_putter_factory('allow_list')
...
put_keyword_presets = preinstanced_array_putter_factory('presets')
...
put_keywords = nullable_string_array_optional_putter_factory('keyword_filter')
...
put_mention_limit = int_putter_factory('mention_total_limit')
...
put_raid_protection = bool_optional_putter_factory('mention_raid_protection_enabled', False)
...
put_regex_patterns = nullable_string_array_optional_putter_factory('regex_patterns')
