...
def test__put_mention_limit_into(input_value, defaults):
    """
    Tests whether ``put_mention_limit_into`` works as intended.
    ...
    """
    return put_mention_limit_into(input_value, {}, defaults)
