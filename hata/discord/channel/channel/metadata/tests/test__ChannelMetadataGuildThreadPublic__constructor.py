...
def test__ChannelMetadataGuildThreadPublic__precreate__0():
    """
    Tests whether ``ChannelMetadataGuildThreadPublic.precreate`` works as intended.
    
    Case: all fields given.
    """
    parent_id = 202209180056
    name = 'Armelyrics'
    created_at = DateTime(2020, 5, 14)
    archived = True
    archived_at = DateTime(2021, 5, 14)
    auto_archive_after = 86400
    open_ = True
    owner_id = 202209180057
    slowmode = 60
    applied_tag_ids = [202209180071]
    flags = ChannelFlag(1)
    ...
    channel_metadata = ChannelMetadataGuildThreadPublic.precreate(keyword_parameters)
...
def test__ChannelMetadataGuildThreadPublic__precreate__1():
    """
    Tests whether ``ChannelMetadataGuildThreadPublic.precreate`` works as intended.
