__all__ = ('ChannelMetadataGuildText',)

from scarletio import copy_docs

from ...permission import Permission
from ...permission.permission import (
    PERMISSION_DENY_SEND_MESSAGES_IN_THREADS_ONLY, PERMISSION_MASK_SEND_MESSAGES, PERMISSION_MASK_VIEW_CHANNEL,
...
class ChannelMetadataGuildText(ChannelMetadataGuildTextBase):
    """
    Guild text channel metadata.
