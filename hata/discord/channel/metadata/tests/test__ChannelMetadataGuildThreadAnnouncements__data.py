...
from .. import ChannelMetadataGuildThreadAnnouncements

from .test__ChannelMetadataGuildThreadAnnouncements__constructor import assert_fields_set


def test__ChannelMetadataGuildThreadAnnouncements__from_data():
    """
    Tests whether ``ChannelMetadataGuildThreadAnnouncements.from_data` works as intended.
    """
    parent_id = 202209180022
    name = 'Armelyrics'
    ...
    open_ = True
    owner_id = 202209180023
    slowmode = 60
    
    channel_metadata = ChannelMetadataGuildThreadAnnouncements.from_data({
...
def test__ChannelMetadataGuildThreadAnnouncements__to_data():
    """
    Tests whether ``ChannelMetadataGuildThreadAnnouncements.to_data`` works as intended.
    """
    parent_id = 202209180025
    name = 'Armelyrics'
    created_at = DateTime(2020, 5, 14)
    archived = True
    archived_at = DateTime(2021, 5, 14)
...
def test__ChannelMetadataGuildThreadAnnouncements__update_attributes():
    """
    Tests whether ``ChannelMetadataGuildThreadAnnouncements._update_attributes`` works as intended.
    """
    old_parent_id = 202209180026
    new_parent_id = 202209180027
    old_name = 'Armelyrics'
    new_name = 'Okuu'
    old_archived = True
    new_archived = False
...
def test__ChannelMetadataGuildThreadAnnouncements__difference_update_attributes():
    """
    Tests whether ``ChannelMetadataGuildThreadAnnouncements._difference_update_attributes`` works as intended.
    """
    old_parent_id = 202209180028
    new_parent_id = 202209180029
    old_name = 'Armelyrics'
    new_name = 'Okuu'
    old_archived = True
    new_archived = False
...
def test__ChannelMetadataGuildThreadAnnouncements__from_partial_data():
    """
    Tests whether ``ChannelMetadataGuildThreadAnnouncements._from_partial_data`` works as intended.
    """
    name = 'Armelyrics'
    
    channel_metadata = ChannelMetadataGuildThreadAnnouncements._from_partial_data({
        'name': name,
    })
