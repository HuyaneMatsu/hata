...
async def test__scheduled_event_user_get_chunk():
    """
    Tests whether ``Client.scheduled_event_user_get_chunk`` works as intended.
    """
    client_id = 202602080000
    user_id_0 = 202602080001
    user_id_1 = 202602080002
    guild_id = 202602080003
    scheduled_event_id = 202602080004
    ...
    scheduled_event_user_get_chunk_called = False
    ...
    async def mock_scheduled_event_user_get_chunk(input_guild_id, input_scheduled_event_id, input_query):
        ...
        nonlocal after
        nonlocal limit
        nonlocal scheduled_event_user_get_chunk_called
        ...
        scheduled_event_user_get_chunk_called = True
    ...
    try:
        output = await client.scheduled_event_user_get_chunk(scheduled_event, after = after, limit = limit)
        
        vampytest.assert_true(scheduled_event_user_get_chunk_called)
        vampytest.assert_eq(
            output,
            [
