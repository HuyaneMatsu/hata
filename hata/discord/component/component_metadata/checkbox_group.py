__all__ = ('ComponentMetadataCheckboxGroup', )
...
from .fields import (
    parse_custom_id, parse_max_values, parse_min_values, parse_options__checkbox_group, parse_required, put_custom_id,
    put_max_values, put_min_values, put_options__checkbox_group, put_required, validate_custom_id,
    validate_max_values__select, validate_min_values__select, validate_options__checkbox_group, validate_required
)


class ComponentMetadataCheckboxGroup(ComponentMetadataBase):
    """
    Checkbox group component metadata.
    ...
    options : ``None | tuple<CheckboxGroupOption>``
    ...
    def __new__(
        ...
        *,
        ...
        """
        Creates a new checkbox group component metadata with the given parameters.
        ...
        options : `None`, `iterable` of ``CheckboxGroupOption``, Optional (Keyword only)
            Options of the checkbox group.
        ...
        if options is ...:
            ...
            options = validate_options__checkbox_group(options)
    ...
    def from_data(cls, data):
        ...
        self.options = parse_options__checkbox_group(data)
    ...
    def to_data(self, *, defaults = False, include_internals = False):
        ...
        put_options__checkbox_group(self.options, data, defaults)
    ...
    def copy_with(
        ...
        *,
        ...
        """
        Copies the checkbox group component metadata with the given fields.
