...
def test__ComponentMetadataRoleSelect__eq(keyword_parameters_0, keyword_parameters_1):
    """
    ...
    output : `bool`
    """
    component_metadata_0 = ComponentMetadataRoleSelect(**keyword_parameters_0)
    component_metadata_1 = ComponentMetadataRoleSelect(**keyword_parameters_1)
