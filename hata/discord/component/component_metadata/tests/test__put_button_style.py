...
from ..fields import put_button_style
...
def test__put_button_style(input_value, defaults):
    """
    Tests whether ``put_button_style`` is working as intended.
    ...
    """
    return put_button_style(input_value, {}, defaults)
