...
from ..fields import put_default_values
...
def test__put_default_values(input_value, defaults):
    """
    Tests whether ``put_default_values`` works as intended.
    ...
    """
    return put_default_values(input_value, {}, defaults)
