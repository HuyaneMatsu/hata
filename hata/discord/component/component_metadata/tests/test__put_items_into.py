...
from ..fields import put_items_into
...
def test__put_items_into(input_value, defaults):
    """
    Tests whether ``put_items_into`` works as intended.
    ...
    """
    return put_items_into(input_value, {}, defaults)
