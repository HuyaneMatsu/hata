...
from ..fields import put_options__string_select
...
def test__put_options__string_select(input_value, defaults):
    """
    Tests whether ``put_options__string_select`` works as intended.
    ...
    """
    return put_options__string_select(input_value, {}, defaults)
