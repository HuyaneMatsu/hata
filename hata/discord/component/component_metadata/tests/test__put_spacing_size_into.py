...
from ..fields import put_spacing_size_into
...
def test__put_spacing_size_into(input_value, defaults):
    """
    Tests whether ``put_spacing_size_into`` is working as intended.
    ...
    """
    return put_spacing_size_into(input_value, {}, defaults)
