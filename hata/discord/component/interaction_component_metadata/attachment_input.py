__all__ = ('InteractionComponentMetadataAttachmentInput',)
...
class InteractionComponentMetadataAttachmentInput(InteractionComponentMetadataStringSelect):
    """
    Interaction component metadata representing an attachment input component.
    ...
    def iter_custom_ids_and_values(self):
        ...
        if (custom_id is not None):
            yield (custom_id, ComponentType.attachment_input, self.values)
