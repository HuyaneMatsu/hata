__all__ = ('InteractionComponentMetadataCheckbox',)
...
from .fields import parse_value__bool, put_value__bool, validate_value__bool


ComponentType = include('ComponentType')


class InteractionComponentMetadataCheckbox(InteractionComponentMetadataBase):
    """
    Interaction component metadata representing a checkbox component.
    ...
    def __new__(cls, *, custom_id = ..., value = ...):
        """
        ...
        if value is ...:
            ...
            value = validate_value__bool(value)
    ...
    def from_data(cls, data):
        ...
        self.value = parse_value__bool(data)
        return self
    ...
    def to_data(self, *, defaults = False):
        ...
        put_value__bool(self.value, data, defaults)
        return data
    ...
    def copy_with(self, *, custom_id = ..., value = ...):
        """
    ...
    def iter_custom_ids_and_values(self):
        custom_id = self.custom_id
        if (custom_id is not None):
            yield (custom_id, ComponentType.checkbox, self.value)
