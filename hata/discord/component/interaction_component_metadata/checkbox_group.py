__all__ = ('InteractionComponentMetadataCheckboxGroup',)
...
class InteractionComponentMetadataCheckboxGroup(InteractionComponentMetadataStringSelect):
    """
    Interaction component metadata representing a checkbox group component.
    ...
    def iter_custom_ids_and_values(self):
        ...
        if (custom_id is not None):
            yield (custom_id, ComponentType.checkbox_group, self.values)
