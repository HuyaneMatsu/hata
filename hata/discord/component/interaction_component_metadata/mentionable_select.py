__all__ = ('InteractionComponentMetadataMentionableSelect',)
...
class InteractionComponentMetadataMentionableSelect(InteractionComponentMetadataStringSelect):
    """
    Interaction component metadata representing a mentionable (role and user) select component.
    ...
    def iter_custom_ids_and_values(self):
        ...
        if (custom_id is not None):
            yield (custom_id, ComponentType.mentionable_select, self.values)
