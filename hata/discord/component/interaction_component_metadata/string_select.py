__all__ = ('InteractionComponentMetadataStringSelect',)
...
class InteractionComponentMetadataStringSelect(InteractionComponentMetadataBase):
    """
    Interaction component metadata representing a string select component.
    ...
    def __new__(cls, *, custom_id = ..., values = ...):
        """
    ...
    def __repr__(self):
        ...
        repr_parts.append(repr(self.values))
    ...
    def copy_with(self, *, custom_id = ..., values = ...):
        """
    ...
    def iter_custom_ids_and_values(self):
        custom_id = self.custom_id
        if (custom_id is not None):
            yield (custom_id, ComponentType.string_select, self.values)
