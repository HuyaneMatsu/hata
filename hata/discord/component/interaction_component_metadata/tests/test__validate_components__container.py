...
def _iter_options__passing():
    ...
    yield (
        [
            interaction_component__section,
        ],
        (
            interaction_component__section,
        ),
    ...
    yield (
        [
            interaction_component__media_gallery,
        ],
        (
            interaction_component__media_gallery,
        ),
    ...
    yield (
        [
            interaction_component__attachment_media,
        ],
        (
            interaction_component__attachment_media,
        ),
    ...
    yield (
        [
            interaction_component__separator,
        ],
        (
            interaction_component__separator,
        ),
...
def test__validate_components__container(input_value):
    """
    Tests whether `validate_components__container` works as intended.
    ...
    ValueError
    """
    output = validate_components__container(input_value)
