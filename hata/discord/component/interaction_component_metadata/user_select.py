__all__ = ('InteractionComponentMetadataUserSelect',)
...
class InteractionComponentMetadataUserSelect(InteractionComponentMetadataStringSelect):
    """
    Interaction component metadata representing a user select component.
    ...
    def iter_custom_ids_and_values(self):
        ...
        if (custom_id is not None):
            yield (custom_id, ComponentType.user_select, self.values)
