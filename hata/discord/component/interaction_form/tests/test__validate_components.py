...
def _iter_options__passing():
    ...
    yield None, None
    yield [], None
    yield [component_0], (Component(ComponentType.row, components = [component_0]), )
    yield [component_1, component_0], (component_1, Component(ComponentType.row, components = [component_0]))
