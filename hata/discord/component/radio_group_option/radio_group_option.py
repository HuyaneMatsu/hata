...
class RadioGroupOption(RichAttributeErrorBaseType):
    """
    An option of a radio group component.
    ...
    def __new__(cls, value, label = ..., default = ..., description = ...):
        """
        Creates a new radio group option with the given parameters.
    ...
    def from_data(cls, data):
        """
        Creates a new radio group option from the given data.
    ...
    def to_data(self, *, defaults = False):
        """
        Converts the radio group option to a json serializable object.
    ...
    def __repr__(self):
        """Returns the radio group option's representation."""
    ...
    def __eq__(self, other):
        """Returns whether the two radio group options are equal."""
    ...
    def __hash__(self):
        """Returns the radio group option's hash value."""
        hash_value = 0
    ...
    def copy_with(
        ...
        """
        Copes the radio group with modifying it's defined attributes.
