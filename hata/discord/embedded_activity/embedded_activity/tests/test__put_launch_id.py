...
from ..fields import put_launch_id
...
def test__put_launch_id(input_value, defaults):
    """
    Tests whether ``put_launch_id`` works as intended.
    ...
    """
    return put_launch_id(input_value, {}, defaults)
