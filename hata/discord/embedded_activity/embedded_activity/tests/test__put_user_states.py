...
from ..fields import put_user_states
...
def test__put_user_states(input_value, defaults, guild_id):
    """
    Tests whether ``put_user_states`` works as intended.
    ...
    """
    return put_user_states(input_value, {}, defaults, guild_id = guild_id)
