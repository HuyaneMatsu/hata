...
def generate_builtin_emojis():
    for emoji_id, element in enumerate((
            ...
            (b'\xf0\x9f\x97\xaf', 'anger_right', 'old_anger_right'),
            ...
            (b'\xe2\x97\x80', 'arrow_backward', 'old_arrow_backward'),
            (b'\xe2\x8f\xac', 'arrow_double_down', 'arrow_double_down'),
            (b'\xe2\x8f\xab', 'arrow_double_up', 'arrow_double_up'),
            (b'\xe2\xac\x87', 'arrow_down', 'old_arrow_down'),
            (b'\xf0\x9f\x94\xbd', 'arrow_down_small', 'arrow_down_small'),
            (b'\xe2\x96\xb6', 'arrow_forward', 'old_arrow_forward'),
            (b'\xe2\xa4\xb5', 'arrow_heading_down', 'old_arrow_heading_down'),
            (b'\xe2\xa4\xb4', 'arrow_heading_up', 'old_arrow_heading_up'),
            (b'\xe2\xac\x85', 'arrow_left', 'old_arrow_left'),
            (b'\xe2\x86\x99', 'arrow_lower_left', 'old_arrow_lower_left'),
            (b'\xe2\x86\x98', 'arrow_lower_right', 'old_arrow_lower_right'),
            (b'\xe2\x9e\xa1', 'arrow_right', 'old_arrow_right'),
            (b'\xe2\x86\xaa', 'arrow_right_hook', 'old_arrow_right_hook'),
            (b'\xe2\xac\x86', 'arrow_up', 'old_arrow_up'),
            (b'\xe2\x86\x95', 'arrow_up_down', 'old_arrow_up_down'),
            (b'\xf0\x9f\x94\xbc', 'arrow_up_small', 'arrow_up_small'),
            (b'\xe2\x86\x96', 'arrow_upper_left', 'old_arrow_upper_left'),
            (b'\xe2\x86\x97', 'arrow_upper_right', 'old_arrow_upper_right'),
            ...
            (b'\xf0\x9f\x97\xb3', 'ballot_box', 'old_ballot_box'),
            (b'\xe2\x98\x91', 'ballot_box_with_check', 'old_ballot_box_with_check'),
            (b'\xf0\x9f\x8e\x8d', 'bamboo', 'bamboo'),
            (b'\xf0\x9f\x8d\x8c', 'banana', 'banana'),
            (b'\xe2\x80\xbc', 'bangbang', 'old_bangbang'),
            ...
            (b'\xe2\x9b\xb9', 'basketball_player', 'old_basketball_player'),
            ...
            (b'\xf0\x9f\x8f\x96', 'beach', 'old_beach'),
            (b'\xe2\x9b\xb1', 'beach_umbrella', 'old_beach_umbrella'),
            (b'\xf0\x9f\x90\xbb', 'bear', 'bear'),
            (b'\xf0\x9f\x9b\x8f', 'bed', 'old_bed'),
            ...
            (b'\xf0\x9f\x9b\x8e', 'bellhop', 'old_bellhop'),
            ...
            (b'\xe2\x98\xa3', 'biohazard', 'old_biohazard'),
            ...
            (b'\xe2\x97\xbc', 'black_medium_square', 'old_black_medium_square'),
            (b'\xe2\x9c\x92', 'black_nib', 'old_black_nib'),
            (b'\xe2\x96\xaa', 'black_small_square', 'old_black_small_square'),
            ...
            (b'\xf0\x9f\x91\xb0', 'bride_with_veil', 'bride_with_veil'),
            (b'\xf0\x9f\x91\xb0\xf0\x9f\x8f\xbb', 'bride_with_veil_tone1', 'bride_with_veil_tone1'),
            (b'\xf0\x9f\x91\xb0\xf0\x9f\x8f\xbc', 'bride_with_veil_tone2', 'bride_with_veil_tone2'),
            (b'\xf0\x9f\x91\xb0\xf0\x9f\x8f\xbd', 'bride_with_veil_tone3', 'bride_with_veil_tone3'),
            (b'\xf0\x9f\x91\xb0\xf0\x9f\x8f\xbe', 'bride_with_veil_tone4', 'bride_with_veil_tone4'),
            (b'\xf0\x9f\x91\xb0\xf0\x9f\x8f\xbf', 'bride_with_veil_tone5', 'bride_with_veil_tone5'),
            ...
            (b'\xf0\x9f\x8f\x97', 'building_construction', 'old_building_construction'),
            ...
            (b'\xf0\x9f\x97\x93', 'calendar_spiral', 'old_calendar_spiral'),
            ...
            (b'\xf0\x9f\x8f\x95', 'camping', 'old_camping'),
            (b'\xe2\x99\x8b', 'cancer', 'cancer'),
            (b'\xf0\x9f\x95\xaf', 'candle', 'old_candle'),
            ...
            (b'\xf0\x9f\x97\x83', 'card_box', 'old_card_box'),
            (b'\xf0\x9f\x93\x87', 'card_index', 'card_index'),
            (b'\xf0\x9f\x97\x82', 'card_index_dividers', 'old_card_index_dividers'),
            ...
            (b'\xe2\x9b\x93', 'chains', 'old_chains'),
            ...
            (b'\xf0\x9f\x90\xbf', 'chipmunk', 'old_chipmunk'),
            ...
            (b'\xf0\x9f\x8f\x99', 'cityscape', 'old_cityscape'),
            ...
            (b'\xf0\x9f\x8f\x9b', 'classical_building', 'old_classical_building'),
            ...
            (b'\xf0\x9f\x95\xb0', 'clock', 'old_clock'),
            ...
            (b'\xe2\x98\x81', 'cloud', 'old_cloud'),
            (b'\xf0\x9f\x8c\xa9', 'cloud_lightning', 'old_cloud_lightning'),
            (b'\xf0\x9f\x8c\xa7', 'cloud_rain', 'old_cloud_rain'),
            (b'\xf0\x9f\x8c\xa8', 'cloud_snow', 'old_cloud_snow'),
            (b'\xf0\x9f\x8c\xaa', 'cloud_tornado', 'old_cloud_tornado'),
            (b'\xf0\x9f\xa4\xa1', 'clown', 'clown', 'clown_face'),
            (b'\xe2\x99\xa3', 'clubs', 'old_clubs'),
            (b'\xf0\x9f\x8d\xb8', 'cocktail', 'cocktail'),
            (b'\xe2\x98\x95', 'coffee', 'coffee'),
            (b'\xe2\x9a\xb0', 'coffin', 'old_coffin'),
            (b'\xf0\x9f\x98\xb0', 'cold_sweat', 'cold_sweat'),
            (b'\xe2\x98\x84', 'comet', 'old_comet'),
            (b'\xf0\x9f\x97\x9c', 'compression', 'old_compression'),
            (b'\xf0\x9f\x92\xbb', 'computer', 'computer'),
            (b'\xf0\x9f\x8e\x8a', 'confetti_ball', 'confetti_ball'),
            (b'\xf0\x9f\x98\x96', 'confounded', 'confounded'),
            (b'\xe3\x8a\x97', 'congratulations', 'old_congratulations'),
            ...
            (b'\xf0\x9f\x8e\x9b', 'control_knobs', 'old_control_knobs'),
            ...
            (b'\xc2\xa9', 'copyright', 'old_copyright'),
            (b'\xf0\x9f\x8c\xbd', 'corn', 'corn'),
            (b'\xf0\x9f\x9b\x8b', 'couch', 'old_couch'),
            ...
            (b'\xf0\x9f\x97\xa1', 'dagger', 'old_dagger'),
            ...
            (b'\xf0\x9f\x95\xb6', 'dark_sunglasses', 'old_dark_sunglasses'),
            ...
            (b'\xf0\x9f\x8f\x9a', 'derelict_house_building', 'old_derelict_house_building'),
            (b'\xf0\x9f\x8f\x9c', 'desert', 'old_desert'),
            (b'\xf0\x9f\x8f\x9d', 'desert_island', 'old_desert_island'),
            (b'\xf0\x9f\x96\xa5', 'desktop', 'old_desktop'),
            (b'\xf0\x9f\x92\xa0', 'diamond_shape_with_a_dot_inside', 'diamond_shape_with_a_dot_inside'),
            (b'\xe2\x99\xa6', 'diamonds', 'old_diamonds'),
            ...
            (b'\xe2\x8f\xb8', 'double_vertical_bar', 'old_double_vertical_bar'),
            (b'\xf0\x9f\x8d\xa9', 'doughnut', 'doughnut'),
            (b'\xf0\x9f\x95\x8a', 'dove', 'old_dove'),
            ...
            (b'\xe2\x9c\xb4', 'eight_pointed_black_star', 'old_eight_pointed_black_star'),
            (b'\xe2\x9c\xb3', 'eight_spoked_asterisk', 'old_eight_spoked_asterisk'),
            (b'\xe2\x8f\x8f', 'eject', 'old_eject'),
            (b'\xf0\x9f\x94\x8c', 'electric_plug', 'electric_plug'),
            (b'\xf0\x9f\x90\x98', 'elephant', 'elephant'),
            (b'\xf0\x9f\x94\x9a', 'end', 'end'),
            (b'\xe2\x9c\x89', 'envelope', 'old_envelope'),
            ...
            (b'\xe2\x9b\xb4', 'ferry', 'old_ferry'),
            (b'\xf0\x9f\x8f\x91', 'field_hockey', 'field_hockey'),
            (b'\xf0\x9f\x97\x84', 'file_cabinet', 'old_file_cabinet'),
            (b'\xf0\x9f\x93\x81', 'file_folder', 'file_folder'),
            (b'\xf0\x9f\x8e\x9e', 'film_frames', 'old_film_frames'),
            (b'\xf0\x9f\x93\xbd', 'film_projector', 'old_film_projector'),
            ...
            (b'\xf0\x9f\x8f\xb3', 'flag_white', 'old_flag_white'),
            ...
            (b'\xe2\x9a\x9c', 'fleur_de_lis', 'old_fleur_de_lis'),
            ...
            (b'\xf0\x9f\x8d\xbd', 'fork_and_knife_with_plate', 'old_fork_and_knife_with_plate'),
            (b'\xe2\x9b\xb2', 'fountain', 'fountain'),
            (b'4\xe2\x83\xa3', 'four', 'old_four'),
            (b'\xf0\x9f\x8d\x80', 'four_leaf_clover', 'four_leaf_clover'),
            (b'\xf0\x9f\xa6\x8a', 'fox', 'fox', 'fox_face'),
            (b'\xf0\x9f\x96\xbc', 'frame_photo', 'old_frame_photo'),
            ...
            (b'\xe2\x98\xb9', 'frowning2', 'old_frowning2'),
            ...
            (b'\xe2\x9a\xb1', 'funeral_urn', 'old_funeral_urn'),
            ...
            (b'\xf0\x9f\x8f\x8c', 'golfer', 'old_golfer'),
            ...
            (b'\xe2\x9a\x92', 'hammer_and_pick', 'old_hammer_and_pick'),
            (b'\xf0\x9f\x9b\xa0', 'hammer_and_wrench', 'old_hammer_and_wrench'),
            (b'\xf0\x9f\x90\xb9', 'hamster', 'hamster'),
            (b'\xf0\x9f\x96\x90', 'hand_splayed', 'old_hand_splayed'),
            ...
            (b'\xe2\x9d\xa4', 'heart', 'old_heart'),
            (b'\xf0\x9f\x92\x9f', 'heart_decoration', 'heart_decoration'),
            (b'\xe2\x9d\xa3', 'heart_exclamation', 'old_heart_exclamation'),
            ...
            (b'\xe2\x99\xa5', 'hearts', 'old_hearts'),
            (b'\xe2\x9c\x94', 'heavy_check_mark', 'old_heavy_check_mark'),
            ...
            (b'\xe2\x9c\x96', 'heavy_multiplication_x', 'old_heavy_multiplication_x'),
            (b'\xe2\x9e\x95', 'heavy_plus_sign', 'heavy_plus_sign'),
            (b'\xf0\x9f\x9a\x81', 'helicopter', 'helicopter'),
            (b'\xe2\x9b\x91', 'helmet_with_cross', 'old_helmet_with_cross'),
            ...
            (b'\xf0\x9f\x95\xb3', 'hole', 'old_hole'),
            (b'\xf0\x9f\x8f\x98', 'homes', 'old_homes'),
            ...
            (b'\xf0\x9f\x8c\xb6', 'hot_pepper', 'old_hot_pepper'),
            (b'\xf0\x9f\x8f\xa8', 'hotel', 'hotel'),
            (b'\xe2\x99\xa8', 'hotsprings', 'old_hotsprings'),
            ...
            (b'\xe2\x9b\xb8', 'ice_skate', 'old_ice_skate'),
            ...
            (b'\xe2\x84\xb9', 'information_source', 'old_information_source'),
            (b'\xe2\x81\x89', 'interrobang', 'old_interrobang'),
            (b'\xf0\x9f\x93\xb1', 'iphone', 'iphone'),
            ...
            (b'\xf0\x9f\x95\xb9', 'joystick', 'old_joystick'),
            ...
            (b'\xf0\x9f\x97\x9d', 'key2', 'old_key2'),
            (b'\xf0\x9f\x94\x91', 'key', 'key'),
            (b'\xe2\x8c\xa8', 'keyboard', 'old_keyboard'),
            ...
            (b'\xf0\x9f\x8f\xb7', 'label', 'old_label'),
            ...
            (b'\xe2\x86\x94', 'left_right_arrow', 'old_left_right_arrow'),
            (b'\xf0\x9f\x97\xa8', 'left_speech_bubble', 'old_left_speech_bubble'),
            (b'\xe2\x86\xa9', 'leftwards_arrow_with_hook', 'old_leftwards_arrow_with_hook'),
            (b'\xf0\x9f\x8d\x8b', 'lemon', 'lemon'),
            (b'\xe2\x99\x8c', 'leo', 'leo'),
            (b'\xf0\x9f\x90\x86', 'leopard', 'leopard'),
            (b'\xf0\x9f\x8e\x9a', 'level_slider', 'old_level_slider'),
            (b'\xf0\x9f\x95\xb4', 'levitate', 'old_levitate'),
            ...
            (b'\xf0\x9f\x8f\x8b', 'lifter', 'old_lifter'),
            ...
            (b'\xf0\x9f\x96\x87', 'linked_paperclips', 'old_linked_paperclips'),
            ...
            (b'\xf0\x9f\x96\x8a', 'lower_left_ballpoint_pen', 'old_lower_left_ballpoint_pen'),
            (b'\xf0\x9f\x96\x8b', 'lower_left_fountain_pen', 'old_lower_left_fountain_pen'),
            (b'\xf0\x9f\x96\x8c', 'lower_left_paintbrush', 'old_lower_left_paintbrush'),
            (b'\xe2\x93\x82', 'm', 'old_m'),
            ...
            (b'\xf0\x9f\xa4\xb5', 'man_in_tuxedo', 'man_in_tuxedo'),
            (b'\xf0\x9f\xa4\xb5\xf0\x9f\x8f\xbb', 'man_in_tuxedo_tone1', 'man_in_tuxedo_tone1', 'tuxedo_tone1'),
            (b'\xf0\x9f\xa4\xb5\xf0\x9f\x8f\xbc', 'man_in_tuxedo_tone2', 'man_in_tuxedo_tone2', 'tuxedo_tone2'),
            (b'\xf0\x9f\xa4\xb5\xf0\x9f\x8f\xbd', 'man_in_tuxedo_tone3', 'man_in_tuxedo_tone3', 'tuxedo_tone3'),
            (b'\xf0\x9f\xa4\xb5\xf0\x9f\x8f\xbe', 'man_in_tuxedo_tone4', 'man_in_tuxedo_tone4', 'tuxedo_tone4'),
            (b'\xf0\x9f\xa4\xb5\xf0\x9f\x8f\xbf', 'man_in_tuxedo_tone5', 'man_in_tuxedo_tone5', 'tuxedo_tone5'),
            ...
            (b'\xf0\x9f\x8e\x99', 'microphone2', 'old_microphone2'),
            ...
            (b'\xf0\x9f\x8e\x96', 'military_medal', 'old_military_medal'),
            ...
            (b'\xf0\x9f\x9b\xa5', 'motorboat', 'old_motorboat'),
            (b'\xf0\x9f\x8f\x8d', 'motorcycle', 'old_motorcycle'),
            (b'\xf0\x9f\x9b\xa3', 'motorway', 'old_motorway'),
            (b'\xf0\x9f\x97\xbb', 'mount_fuji', 'mount_fuji'),
            (b'\xe2\x9b\xb0', 'mountain', 'old_mountain'),
            ...
            (b'\xf0\x9f\x8f\x94', 'mountain_snow', 'old_mountain_snow'),
            (b'\xf0\x9f\x90\x81', 'mouse2', 'mouse2'),
            (b'\xf0\x9f\x90\xad', 'mouse', 'mouse'),
            (b'\xf0\x9f\x96\xb1', 'mouse_three_button', 'old_mouse_three_button'),
            ...
            (b'\xf0\x9f\x8f\x9e', 'national_park', 'old_national_park'),
            ...
            (b'\xf0\x9f\x97\x9e', 'newspaper2', 'old_newspaper2'),
            (b'\xf0\x9f\x93\xb0', 'newspaper', 'newspaper'),
            (b'\xe2\x8f\xad', 'next_track', 'old_next_track'),
            (b'\xf0\x9f\x86\x96', 'ng', 'ng'),
            (b'\xf0\x9f\x8c\x83', 'night_with_stars', 'night_with_stars'),
            (b'9\xe2\x83\xa3', 'nine', 'old_nine'),
            ...
            (b'\xf0\x9f\x97\x92', 'notepad_spiral', 'old_notepad_spiral'),
            (b'\xf0\x9f\x8e\xb6', 'notes', 'notes'),
            (b'\xf0\x9f\x94\xa9', 'nut_and_bolt', 'nut_and_bolt'),
            (b'\xf0\x9f\x85\xbe', 'o2', 'old_o2'),
            (b'\xe2\xad\x95', 'o', 'o'),
            ...
            (b'\xf0\x9f\x95\x89', 'om_symbol', 'old_om_symbol'),
            ...
            (b'\xe2\x98\xa6', 'orthodox_cross', 'old_orthodox_cross'),
            ...
            (b'\xe2\x8f\xaf', 'play_pause', 'old_play_pause'),
            ...
            (b'\xe2\x98\x9d', 'point_up', 'old_point_up'),
            ...
            (b'\xe2\x8f\xae', 'previous_track', 'old_previous_track'),
            ...
            (b'\xf0\x9f\x96\xa8', 'printer', 'old_printer'),
            ...
            (b'\xf0\x9f\x8f\x8e', 'race_car', 'old_race_car'),
            (b'\xf0\x9f\x90\x8e', 'racehorse', 'racehorse'),
            (b'\xf0\x9f\x93\xbb', 'radio', 'radio'),
            (b'\xf0\x9f\x94\x98', 'radio_button', 'radio_button'),
            (b'\xe2\x98\xa2', 'radioactive', 'old_radioactive'),
            (b'\xf0\x9f\x9b\xa4', 'railroad_track', 'old_railroad_track'),
            ...
            (b'\xe2\x8f\xba', 'record_button', 'old_record_button'),
            (b'\xe2\x99\xbb', 'recycle', 'old_recycle'),
            ...
            (b'\xc2\xae', 'registered', 'old_registered'),
            (b'\xe2\x98\xba', 'relaxed', 'old_relaxed'),
            (b'\xf0\x9f\x98\x8c', 'relieved', 'relieved'),
            (b'\xf0\x9f\x8e\x97', 'reminder_ribbon', 'old_reminder_ribbon'),
            ...
            (b'\xf0\x9f\x8f\xb5', 'rosette', 'old_rosette'),
            ...
            (b'\xf0\x9f\x9b\xb0', 'satellite_orbital', 'old_satellite_orbital'),
            (b'\xf0\x9f\x8e\xb7', 'saxophone', 'saxophone'),
            (b'\xe2\x9a\x96', 'scales', 'old_scales'),
            (b'\xf0\x9f\x8f\xab', 'school', 'school'),
            (b'\xf0\x9f\x8e\x92', 'school_satchel', 'school_satchel'),
            (b'\xe2\x9c\x82', 'scissors', 'old_scissors'),
            ...
            (b'\xe3\x8a\x99', 'secret', 'old_secret'),
            ...
            (b'7\xe2\x83\xa3', 'seven', 'old_seven'),
            (b'\xe2\x98\x98', 'shamrock', 'old_shamrock'),
            ...
            (b'\xf0\x9f\x9b\xa1', 'shield', 'old_shield'),
            (b'\xe2\x9b\xa9', 'shinto_shrine', 'old_shinto_shrine'),
            (b'\xf0\x9f\x9a\xa2', 'ship', 'ship'),
            (b'\xf0\x9f\x91\x95', 'shirt', 'shirt'),
            (b'\xf0\x9f\x9b\x8d', 'shopping_bags', 'old_shopping_bags'),
            ...
            (b'\xe2\x98\xa0', 'skull_and_crossbones', 'old_skull_and_crossbones'),
            ...
            (b'\xe2\x9d\x84', 'snowflake', 'old_snowflake'),
            (b'\xe2\x98\x83', 'snowman2', 'old_snowman2'),
            ...
            (b'\xe2\x99\xa0', 'spades', 'old_spades'),
            (b'\xf0\x9f\x8d\x9d', 'spaghetti', 'spaghetti'),
            (b'\xe2\x9d\x87', 'sparkle', 'old_sparkle'),
            ...
            (b'\xf0\x9f\x97\xa3', 'speaking_head', 'old_speaking_head'),
            (b'\xf0\x9f\x92\xac', 'speech_balloon', 'speech_balloon'),
            (b'\xf0\x9f\x9a\xa4', 'speedboat', 'speedboat'),
            (b'\xf0\x9f\x95\xb7', 'spider', 'old_spider'),
            (b'\xf0\x9f\x95\xb8', 'spider_web', 'old_spider_web'),
            (b'\xf0\x9f\xa5\x84', 'spoon', 'spoon'),
            (b'\xf0\x9f\xa6\x91', 'squid', 'squid'),
            (b'\xf0\x9f\x8f\x9f', 'stadium', 'old_stadium'),
            (b'\xf0\x9f\x8c\x9f', 'star2', 'star2'),
            (b'\xe2\xad\x90', 'star', 'star'),
            (b'\xe2\x98\xaa', 'star_and_crescent', 'old_star_and_crescent'),
            (b'\xe2\x9c\xa1', 'star_of_david', 'old_star_of_david'),
            ...
            (b'\xe2\x8f\xb9', 'stop_button', 'old_stop_button'),
            (b'\xe2\x8f\xb1', 'stopwatch', 'old_stopwatch'),
            ...
            (b'\xe2\x98\x8e', 'telephone', 'old_telephone'),
            ...
            (b'\xf0\x9f\x8c\xa1', 'thermometer', 'old_thermometer'),
            ...
            (b'3\xe2\x83\xa3', 'three', 'old_three'),
            (b'\xe2\x9b\x88', 'thunder_cloud_and_rain', 'old_thunder_cloud_and_rain'),
            (b'\xf0\x9f\x8e\xab', 'ticket', 'ticket'),
            (b'\xf0\x9f\x90\x85', 'tiger2', 'tiger2'),
            (b'\xf0\x9f\x90\xaf', 'tiger', 'tiger'),
            (b'\xe2\x8f\xb2', 'timer', 'old_timer'),
            (b'\xf0\x9f\x98\xab', 'tired_face', 'tired_face'),
            (b'\xe2\x84\xa2', 'tm', 'old_tm'),
            ...
            (b'\xf0\x9f\x96\xb2', 'trackball', 'old_trackball'),
            ...
            (b'\xf0\x9f\x88\xb7', 'u6708', 'old_u6708'),
            ...
            (b'\xe2\x98\x82', 'umbrella2', 'old_umbrella2'),
            ...
            (b'\xe2\x9a\xa0', 'warning', 'old_warning'),
            (b'\xf0\x9f\x97\x91', 'wastebasket', 'old_wastebasket'),
            ...
            (b'\xe3\x80\xb0', 'wavy_dash', 'old_wavy_dash'),
            ...
            (b'\xe2\x98\xb8', 'wheel_of_dharma', 'old_wheel_of_dharma'),
            ...
            (b'\xe2\x97\xbb', 'white_medium_square', 'old_white_medium_square'),
            (b'\xe2\x96\xab', 'white_small_square', 'old_white_small_square'),
            (b'\xf0\x9f\x94\xb3', 'white_square_button', 'white_square_button'),
            (b'\xf0\x9f\x8c\xa5', 'white_sun_behind_cloud', 'old_white_sun_behind_cloud'),
            (b'\xf0\x9f\x8c\xa6', 'white_sun_behind_cloud_with_rain', 'old_white_sun_behind_cloud_with_rain'),
            (b'\xf0\x9f\x8c\xa4', 'white_sun_small_cloud', 'old_white_sun_small_cloud'),
            (b'\xf0\x9f\xa5\x80', 'wilted_flower', 'wilted_flower', 'wilted_rose'),
            (b'\xf0\x9f\x8c\xac', 'wind_blowing_face', 'old_wind_blowing_face'),
            ...
            (b'\xe2\x9c\x8d', 'writing_hand', 'old_writing_hand'),
            ...
            (b'\xe2\x98\xaf', 'yin_yang', 'old_yin_yang'),
            (b'\xf0\x9f\x98\x8b', 'yum', 'yum'),
            (b'\xe2\x9a\xa1', 'zap', 'zap'),
            (b'0\xe2\x83\xa3', 'zero', 'old_zero'),
            ...
            (b'\xf0\x9f\xa6\x97', 'cricket', 'cricket'),
