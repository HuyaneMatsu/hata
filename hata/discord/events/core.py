...
add_event_handler('user_update', 3, 'PRESENCE_UPDATE',)
...
add_event_handler('channel_update', 3, ('CHANNEL_UPDATE', 'THREAD_UPDATE'),)
...
add_event_handler('guild_update', 2, 'GUILD_UPDATE',)
...
add_event_handler('integration_update', 3, 'INTEGRATION_UPDATE',)
...
add_event_handler('role_update', 3, 'GUILD_ROLE_UPDATE',)
...
add_event_handler('stage_update', 3, 'STAGE_INSTANCE_UPDATE',)
...
add_event_handler('thread_user_update', 4, 'THREAD_MEMBER_UPDATE')
...
add_event_handler('scheduled_event_update', 3, 'GUILD_SCHEDULED_EVENT_UPDATE',)
