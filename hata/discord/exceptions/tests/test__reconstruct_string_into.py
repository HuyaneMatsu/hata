...
from ..payload_renderer import reconstruct_string_into
...
def test__reconstruct_string_into(input_value, indent, value_is_file, line_width, used_characters):
    """
    Tests whether ``reconstruct_string_into`` works as intended.
    ...
    output : `str`
    """
    into = reconstruct_string_into(input_value, [], indent, value_is_file, line_width, used_characters)
