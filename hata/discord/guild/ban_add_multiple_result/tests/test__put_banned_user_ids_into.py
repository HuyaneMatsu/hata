...
from ..fields import put_banned_user_ids_into
...
def test__put_banned_user_ids_into(input_value, defaults):
    """
    Tests whether ``put_banned_user_ids_into`` is working as intended.
    ...
    """
    return put_banned_user_ids_into(input_value, {}, defaults)
