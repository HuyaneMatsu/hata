...
from ..fields import put_delete_message_duration_into
...
def test__put_delete_message_duration_into(input_value, defaults):
    """
    Tests whether ``put_delete_message_duration_into`` is working as intended.
    ...
    """
    return put_delete_message_duration_into(input_value, {}, defaults)
