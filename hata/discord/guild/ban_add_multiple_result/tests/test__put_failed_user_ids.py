...
from ..fields import put_failed_user_ids
...
def test__put_failed_user_ids(input_value, defaults):
    """
    Tests whether ``put_failed_user_ids`` is working as intended.
    ...
    """
    return put_failed_user_ids(input_value, {}, defaults)
