...
from ...field_parsers import (
    bool_parser_factory, nullable_array_parser_factory, nullable_date_time_parser_factory,
...
put_application_actioned = nullable_date_time_optional_putter_factory('partner_actioned_timestamp')
...
put_application_requested = nullable_date_time_optional_putter_factory('partner_application_timestamp')
...
put_emoji_discovery = bool_optional_putter_factory('emoji_discoverability_enabled', False)
validate_emoji_discovery = bool_validator_factory('emoji_discovery', False)

# keywords

parse_keywords = nullable_array_parser_factory('keywords')
put_keywords = nullable_string_array_optional_putter_factory('keywords')
...
put_primary_category = preinstanced_putter_factory('primary_category_id')
...
put_sub_categories = preinstanced_array_putter_factory('category_ids')
