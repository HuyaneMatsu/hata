...
def _iter_options():
    ...
    yield {}, 0
    yield {'embedded_activity': None}, 0
    yield {'embedded_activity': {}}, 0
    yield {'embedded_activity': {'application_id': None}}, 0
    yield {'embedded_activity': {'application_id': str(application_id)}}, application_id
