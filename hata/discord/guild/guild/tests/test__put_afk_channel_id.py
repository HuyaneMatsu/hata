...
from ..fields import put_afk_channel_id
...
def test__put_afk_channel_id(input_value, defaults):
    """
    Tests whether ``put_afk_channel_id`` works as intended.
    ...
    """
    return put_afk_channel_id(input_value, {}, defaults)
