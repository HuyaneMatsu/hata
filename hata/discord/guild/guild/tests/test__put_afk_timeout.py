...
from ..fields import put_afk_timeout
...
def test__put_afk_timeout(input_value, defaults):
    """
    Tests whether ``put_afk_timeout`` is working as intended.
    ...
    """
    return put_afk_timeout(input_value, {}, defaults)
