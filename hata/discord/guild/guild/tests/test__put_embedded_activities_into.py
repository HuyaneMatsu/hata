...
from ..fields import put_embedded_activities_into
...
def test__put_embedded_activities_into(input_value, defaults):
    """
    Tests whether ``put_embedded_activities_into`` works as intended.
    ...
    """
    return put_embedded_activities_into(input_value, {}, defaults)
