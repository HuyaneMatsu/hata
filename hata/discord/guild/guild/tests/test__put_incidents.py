...
from ..fields import put_incidents
...
def test__put_incidents(input_value, defaults):
    """
    Tests whether ``put_incidents`` works as intended.
    ...
    """
    return put_incidents(input_value, {}, defaults)
