...
from ..fields import put_inventory_settings_into
...
def test__put_inventory_settings_into(input_value, defaults):
    """
    Tests whether ``put_inventory_settings_into`` works as intended.
    ...
    """
    return put_inventory_settings_into(input_value, {}, defaults)
