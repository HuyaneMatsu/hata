...
from ..fields import put_roles_and_role_datas
...
def test__put_roles_and_role_datas(input_value, defaults):
    """
    Tests whether ``put_roles_and_role_datas`` works as intended.
    ...
    """
    return put_roles_and_role_datas(input_value, {}, defaults)
