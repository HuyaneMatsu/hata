...
def test__put_stages(input_value, defaults):
    """
    Tests whether ``put_stages`` works as intended.
    ...
    """
    return put_stages(input_value, {}, defaults)
