...
put_direct_message_spam_detected_at = nullable_date_time_optional_putter_factory('dm_spam_detected_at')
...
put_direct_messages_disabled_until = nullable_date_time_optional_putter_factory('dms_disabled_until')
...
put_invites_disabled_until = nullable_date_time_optional_putter_factory('invites_disabled_until')
...
put_raid_detected_at = nullable_date_time_optional_putter_factory('raid_detected_at')
