...
from ..fields import validate_direct_messages_disabled_duration
...
def test__validate_direct_messages_disabled_duration__passing(current_date, input_value):
    """
    Tests whether ``validate_direct_messages_disabled_duration`` works as intended.
    ...
    mocked = vampytest.mock_globals(validate_direct_messages_disabled_duration, DateTime = DateTimeMock)
...
def test__validate_direct_messages_disabled_duration__type_error(input_value):
    """
    Tests whether ``validate_direct_messages_disabled_duration`` works as intended.
    ...
    TypeError
    """
    validate_direct_messages_disabled_duration(input_value)
