...
def _iter_options():
    ...
    yield {}, None
    yield {'actioned_at': None}, None
    yield {'actioned_at': datetime_to_timestamp(timestamp)}, timestamp


@vampytest._(vampytest.call_from(_iter_options()).returning_last())
def test__parse_actioned_at(input_data):
    """
    ...
    """
    output = parse_actioned_at(input_data)
