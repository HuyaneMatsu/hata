...
from ..fields import put_form_responses


def test__put_form_responses():
    """
    Tests whether ``put_form_responses`` works as intended.
    """
    ...
    for input_value, defaults, expected_output in (
        ...
        output = put_form_responses(input_value, {}, defaults)
