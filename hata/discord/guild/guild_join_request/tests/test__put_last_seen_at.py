...
from ..fields import put_last_seen_at
...
def test__put_last_seen_at(input_value, defaults):
    """
    Tests whether ``put_last_seen_at`` works as intended.
    ...
    """
    return put_last_seen_at(input_value, {}, defaults)
