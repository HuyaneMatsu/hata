...
from ..guild.fields import parse_id, parse_name, put_id, put_name, validate_id, validate_name
...
put_approximate_online_count = int_putter_factory('presence_count')
...
put_channels = nullable_entity_array_putter_factory('channels', GuildWidgetChannel)
...
put_invite_url = url_optional_putter_factory('instant_invite')
...
put_users = nullable_entity_array_putter_factory('members', GuildWidgetUser)
