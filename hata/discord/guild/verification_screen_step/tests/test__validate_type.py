...
def _iter_options():
    yield None, VerificationScreenStepType.none
    yield VerificationScreenStepType.rules, VerificationScreenStepType.rules
    yield VerificationScreenStepType.rules.value, VerificationScreenStepType.rules
