...
from ..fields import put_welcome_channels


def test__put_welcome_channels():
    """
    Tests whether `put_welcome_channels` works as intended.
    """
    ...
    for input_value, defaults, expected_output in (
        ...
        output = put_welcome_channels(input_value, {}, defaults)
