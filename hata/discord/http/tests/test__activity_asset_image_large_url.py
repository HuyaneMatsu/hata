...
from ..urls import CDN_ENDPOINT, activity_asset_image_large_url
...
def test__activity_asset_image_large_url(application_id, activity_assets):
    """
    Tests whether ``activity_asset_image_large_url`` works as intended.
    ...
    output = activity_asset_image_large_url(activity)
