...
from ..urls import CDN_ENDPOINT, build_guild_discovery_splash_url
...
def test__build_guild_discovery_splash_url(guild_id, icon_type, icon_hash):
    """
    Tests whether ``build_guild_discovery_splash_url`` works as intended.
    ...
    output : `None | str`
    """
    output = build_guild_discovery_splash_url(guild_id, icon_type, icon_hash)
