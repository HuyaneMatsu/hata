...
def _iter_options():
    ...
    yield (
        ...
        'webp',
        None,
        f'{CDN_ENDPOINT}/discovery-splashes/{guild_id}/00000000000000000000000000000004.webp',
    )
    
    guild_id = 202506210011
    yield (
        guild_id,
        IconType.animated,
        4,
        'webp',
        None,
        f'{CDN_ENDPOINT}/discovery-splashes/{guild_id}/a_00000000000000000000000000000004.webp?animated=true',
    )
