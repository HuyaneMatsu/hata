...
from ..urls import CDN_ENDPOINT, build_guild_icon_url
...
def test__build_guild_icon_url(guild_id, icon_type, icon_hash):
    """
    Tests whether ``build_guild_icon_url`` works as intended.
    ...
    output : `None | str`
    """
    output = build_guild_icon_url(guild_id, icon_type, icon_hash)
