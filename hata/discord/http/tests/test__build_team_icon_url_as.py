...
def _iter_options():
    ...
    yield (
        ...
        'webp',
        None,
        f'{CDN_ENDPOINT}/team-icons/{team_id}/00000000000000000000000000000004.webp',
    )
    
    team_id = 202506210021
    yield (
        team_id,
        IconType.animated,
        4,
        'webp',
        None,
        f'{CDN_ENDPOINT}/team-icons/{team_id}/a_00000000000000000000000000000004.webp?animated=true',
    )
