...
from ..urls import CDN_ENDPOINT, build_user_banner_url_for_as
...
def test__build_user_banner_url_for_as(user_id, guild_id, icon_type, icon_hash, ext, size):
    """
    Tests whether ``build_user_banner_url_for_as`` works as intended.
    ...
    output : `None | str`
    """
    output = build_user_banner_url_for_as(user_id, guild_id, icon_type, icon_hash, ext, size)
