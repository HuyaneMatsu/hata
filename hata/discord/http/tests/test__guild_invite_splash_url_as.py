...
from ..urls import CDN_ENDPOINT, guild_invite_splash_url_as
...
def test__guild_invite_splash_url_as(guild_id, icon, keyword_parameters):
    """
    Tests whether ``guild_invite_splash_url_as`` works as intended.
    ...
    output = guild_invite_splash_url_as(guild, **keyword_parameters)
