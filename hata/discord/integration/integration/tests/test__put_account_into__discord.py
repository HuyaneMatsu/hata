...
from ..fields import put_account_into__discord


def test__put_account_into__discord():
    """
    Tests whether ``put_account_into__discord`` works as intended.
    """
    ...
    for input_value, expected_output in (
        ...
        data = put_account_into__discord(input_value, {}, True)
