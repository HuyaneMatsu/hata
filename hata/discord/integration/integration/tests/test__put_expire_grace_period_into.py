...
from ..fields import put_expire_grace_period_into


def test__put_default_auto_archive_after_into():
    """
    Tests whether ``put_expire_grace_period_into`` is working as intended.
    """
    for input_, defaults, expected_output in (
        ...
        data = put_expire_grace_period_into(input_, {}, defaults)
