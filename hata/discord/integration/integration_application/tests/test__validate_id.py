...
def _iter_options__passing():
    integration_application_id = 202212170047
    
    yield 0, 0
    yield integration_application_id, integration_application_id
    yield str(integration_application_id), integration_application_id
