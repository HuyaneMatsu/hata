...
from ..fields import put_authorizer_user_ids


def _iter_options():
    user_id_0 = 202407160086
    user_id_1 = 202407160087
...
def test__put_authorizer_user_ids(input_value, defaults):
    """
    Tests whether ``put_authorizer_user_ids`` works as intended.
    ...
    """
    return put_authorizer_user_ids(input_value, {}, defaults)
