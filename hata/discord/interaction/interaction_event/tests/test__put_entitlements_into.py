...
from ..fields import put_entitlements_into
...
def test__put_entitlements_into(input_value, defaults):
    """
    Tests whether ``put_entitlements_into`` works as intended.
    ...
    """
    return put_entitlements_into(input_value, {}, defaults)
