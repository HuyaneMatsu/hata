...
from ..fields import put_guild_into
...
def test__put_guild_into(guild, defaults):
    """
    Tests whether ``put_guild_into`` works as intended.
    ...
    """
    return put_guild_into(guild, {}, defaults)
