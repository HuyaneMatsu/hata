...
from ....application_command.application_command_option.constants import APPLICATION_COMMAND_OPTION_NAME_LENGTH_MAX
...
@vampytest.call_with('a' * (APPLICATION_COMMAND_OPTION_NAME_LENGTH_MAX + 1))
