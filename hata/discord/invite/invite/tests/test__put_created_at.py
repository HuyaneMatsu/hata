...
def _iter_options():
    ...
    yield created_at, False, {'created_at': datetime_to_timestamp(created_at)}
    yield created_at, True, {'created_at': datetime_to_timestamp(created_at)}
    

@vampytest._(vampytest.call_from(_iter_options()).returning_last())
def test__put_created_at(input_value, defaults):
    """
    Tests whether ``put_created_at`` works as intended.
