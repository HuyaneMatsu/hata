...
from ..fields import put_inviter
...
def test__put_inviter(input_value, defaults):
    """
    Tests whether ``put_inviter`` is working as intended.
    ...
    """
    return put_inviter(input_value, {}, defaults)
