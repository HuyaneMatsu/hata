...
from ..fields import put_target_application_into
...
def test__put_target_application_into(application, defaults):
    """
    Tests whether ``put_target_application_into`` works as intended.
    ...
    """
    return put_target_application_into(application, {}, defaults)
