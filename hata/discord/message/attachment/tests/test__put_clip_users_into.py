...
from ..fields import put_clip_users_into
...
def test__put_clip_users_into(input_value, defaults):
    """
    Tests whether ``put_clip_users_into`` works as intended.
    ...
    """
    return put_clip_users_into(input_value, {}, defaults)
