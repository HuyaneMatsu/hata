...
def test__put_author_into__user():
    """
    Tests whether ``put_author_into`` works as intended.
    ...
    output = put_author_into(user, {}, True)
    vampytest.assert_eq(output, expected_output)


def test__put_author_into__user__guild_profile():
    """
    Tests whether ``put_author_into`` works as intended.
    ...
    output = put_author_into(user, {}, True, guild_id = guild_id)
    vampytest.assert_eq(output, expected_output)


def test__put_author_into__webhook():
    """
    Tests whether ``put_author_into`` works as intended.
