...
from ..fields import put_interaction
...
def test__put_interaction(input_value, defaults):
    """
    Tests whether ``put_interaction`` is working as intended.
    ...
    """
    return put_interaction(input_value, {}, defaults)
