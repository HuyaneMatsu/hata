...
from ..fields import put_mentioned_channels_cross_guild


def test__put_mentioned_channels_cross_guild__0():
    """
    Tests whether ``put_mentioned_channels_cross_guild`` works as intended.
    ...
    output = put_mentioned_channels_cross_guild(channels, {}, True)
    vampytest.assert_eq(output, expected_output)


def test__put_mentioned_channels_cross_guild__1():
    """
    Tests whether ``put_mentioned_channels_cross_guild`` works as intended.
    ...
    for input_value, defaults, expected_output in (
        ...
        output = put_mentioned_channels_cross_guild(input_value, {}, defaults)
        vampytest.assert_eq(output, expected_output)
