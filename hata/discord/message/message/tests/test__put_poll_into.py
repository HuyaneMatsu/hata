...
from ..fields import put_poll_into
...
def test__put_poll_into(input_value, defaults, include_internals):
    """
    Tests whether ``put_poll_into`` is working as intended.
    ...
    """
    return put_poll_into(input_value, {}, defaults, include_internals = include_internals)
