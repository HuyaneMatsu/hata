...
from ..fields import put_reactions
...
def test__put_reactions(input_value, defaults):
    """
    Tests whether ``put_reactions`` works as intended.
    ...
    """
    return put_reactions(input_value, {}, defaults)
