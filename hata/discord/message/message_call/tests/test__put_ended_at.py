...
from ..fields import put_ended_at
...
def test__put_ended_at(input_value, defaults):
    """
    Tests whether ``put_ended_at`` works as intended.
    ...
    """
    return put_ended_at(input_value, {}, defaults)
