...
from ..fields import put_interacted_message_id
...
def test__put_interacted_message_id(interacted_message_id, defaults):
    """
    Tests whether ``put_interacted_message_id`` works as intended.
    ...
    """
    return put_interacted_message_id(interacted_message_id, {}, defaults)
