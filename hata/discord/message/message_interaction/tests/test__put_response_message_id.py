...
from ..fields import put_response_message_id
...
def test__put_response_message_id(response_message_id, defaults):
    """
    Tests whether ``put_response_message_id`` works as intended.
    ...
    """
    return put_response_message_id(response_message_id, {}, defaults)
