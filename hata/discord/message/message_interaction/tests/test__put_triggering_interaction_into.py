...
from ..fields import put_triggering_interaction_into
...
def test__put_triggering_interaction_into(input_value, defaults, include_internals):
    """
    Tests whether ``put_triggering_interaction_into`` is working as intended.
    ...
    """
    return put_triggering_interaction_into(input_value, {}, defaults, include_internals = include_internals)
