...
def test__parse_subscription_listing_id():
    ...
    """
    subscription_listing_id = 202301190000
    
    for input_data, expected_output in (
        ({}, 0),
        ({'role_subscription_listing_id': None}, 0),
        ({'role_subscription_listing_id': str(subscription_listing_id)}, subscription_listing_id),
    ):
