...
def _iter_options():
    ...
    yield {'message': {}}, None
    yield {'message': {'components': None}}, None
    yield {'message': {'components': []}}, None
    yield {'message': {'components': [component_0.to_data()]}}, (component_0, )
    yield {'message': {'components': [component_1.to_data(), component_0.to_data()]}}, (component_1, component_0)
