...
from ..fields import put_mentioned_users
...
def test__put_mentioned_users(input_value, defaults, guild_id):
    """
    Tests whether ``put_mentioned_users`` works as intended.
    ...
    """
    return put_mentioned_users(input_value, {}, defaults, guild_id = guild_id)
