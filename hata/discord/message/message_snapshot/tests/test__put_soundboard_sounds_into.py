...
from ..fields import put_soundboard_sounds_into


def _iter_options():
    soundboard_sound_id_0 = 202501300002
    soundboard_sound_name_0 = 'Divine'
    
    soundboard_sound_id_1 = 202501300003
...
def test__put_soundboard_sounds_into(input_value, defaults):
    """
    Tests whether ``put_soundboard_sounds_into`` works as intended.
    ...
    """
    return put_soundboard_sounds_into(input_value, {}, defaults)
