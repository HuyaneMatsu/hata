...
put_default_channel_ids = optional_entity_id_array_optional_putter_factory('default_channel_ids')
...
put_mode = preinstanced_putter_factory('mode')
...
put_prompts = nullable_entity_array_putter_factory('prompts', OnboardingPrompt)
