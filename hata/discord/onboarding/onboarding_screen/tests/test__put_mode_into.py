...
from ..fields import put_mode_into
...
def test__put_mode_into(input_value, defaults):
    """
    Tests whether ``put_mode_into`` is working as intended.
    ...
    """
    return put_mode_into(input_value, {}, defaults)
