...
from ..fields import put_answers
...
def test__put_answers(input_value, defaults):
    """
    Tests whether ``put_answers`` works as intended.
    ...
    """
    return put_answers(input_value, {}, defaults, include_internals = True)
