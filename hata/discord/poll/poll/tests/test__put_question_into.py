...
from ..fields import put_question_into
...
def test__put_question_into(input_value, defaults):
    """
    Tests whether ``put_question_into`` works as intended.
    ...
    """
    return put_question_into(input_value, {}, defaults, include_internals = True)
