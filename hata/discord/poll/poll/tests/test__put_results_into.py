...
from ..fields import put_results_into
...
def test__put_results_into(input_value, defaults):
    """
    Tests whether ``put_results_into`` works as intended.
    ...
    """
    return put_results_into(input_value, {}, defaults)
