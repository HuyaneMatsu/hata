...
from ..fields import put_by_months_into
...
def test__put_by_months_into(input_value, defaults):
    """
    Tests whether ``put_by_months_into`` is working as intended.
    ...
    """
    return put_by_months_into(input_value, {}, defaults)
