...
from ..fields import put_by_weeks_days_into
...
def test__put_by_weeks_days_into(input_value, defaults):
    """
    Tests whether ``put_by_weeks_days_into`` is working as intended.
    ...
    """
    return put_by_weeks_days_into(input_value, {}, defaults)
