...
from ..fields import put_frequency_into
...
def test__put_frequency_into(input_value, defaults):
    """
    Tests whether ``put_frequency_into`` is working as intended.
    ...
    """
    return put_frequency_into(input_value, {}, defaults)
