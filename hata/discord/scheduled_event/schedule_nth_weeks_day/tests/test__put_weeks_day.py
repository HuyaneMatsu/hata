...
from ..fields import put_weeks_day
...
def test__put_weeks_day(input_value, defaults):
    """
    Tests whether ``put_weeks_day`` is working as intended.
    ...
    """
    return put_weeks_day(input_value, {}, defaults)
