...
from ..fields import put_entity_type
...
def test__put_entity_type(input_value, defaults):
    """
    Tests whether ``put_entity_type`` works as intended.
    ...
    """
    return put_entity_type(input_value, {}, defaults)
