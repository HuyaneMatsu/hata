...
from ..fields import put_schedule
...
def test__put_schedule(input_value, defaults, start):
    """
    Tests whether ``put_schedule`` works as intended.
    ...
    """
    return put_schedule(input_value, {}, defaults, start = start)
