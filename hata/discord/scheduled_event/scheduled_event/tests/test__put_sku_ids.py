...
from ..fields import put_sku_ids
...
def test__put_sku_ids(input_value, defaults):
    """
    Tests whether ``put_sku_ids`` is working as intended.
    ...
    """
    return put_sku_ids(input_value, {}, defaults)
