...
from ...field_putters import entity_id_array_optional_putter_factory, nullable_string_putter_factory
...
put_speaker_ids_into = entity_id_array_optional_putter_factory('speaker_ids')
