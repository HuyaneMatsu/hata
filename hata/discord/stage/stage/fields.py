...
put_discoverable = negated_bool_optional_putter_factory('discoverable_disabled', True)
...
put_invite_code = url_optional_putter_factory('invite_code')
...
put_send_start_notification = bool_optional_putter_factory('send_start_notification', False)
