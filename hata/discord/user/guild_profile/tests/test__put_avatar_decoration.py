...
from ..fields import put_avatar_decoration
...
def test__put_avatar_decoration(input_value, defaults):
    """
    Tests whether ``put_avatar_decoration`` is working as intended.
    ...
    """
    return put_avatar_decoration(input_value, {}, defaults)
