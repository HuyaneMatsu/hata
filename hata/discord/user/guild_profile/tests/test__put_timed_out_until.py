...
from ..fields import put_timed_out_until
...
def test__put_timed_out_until(input_value, defaults):
    """
    Tests whether ``put_timed_out_until`` works as intended.
    ...
    """
    return put_timed_out_until(input_value, {}, defaults)
