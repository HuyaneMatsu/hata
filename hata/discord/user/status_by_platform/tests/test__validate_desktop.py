...
from ..fields import validate_desktop
...
def test__validate_desktop(input_value):
    """
    Validates whether ``validate_desktop`` works as intended.
    ...
    TypeError
    """
    output = validate_desktop(input_value)
