...
class ChannelCreateEvent(EventBase):
    ...
    @copy_docs(EventBase.__repr__)
    def __repr__(self):
        return f'<{type(self).__name__} id = {self.id}, name = {self.name!r}, type = {self.type}>'
...
class ChannelVoiceSelectEvent(EventBase):
    ...
    @copy_docs(EventBase.__repr__)
    def __repr__(self):
        return f'<{type(self).__name__} guild_id = {self.guild_id}, channel_id = {self.channel_id}>'
...
class NotificationCreateEvent(EventBase):
    ...
    @copy_docs(EventBase.__repr__)
    def __repr__(self):
        return f'<{type(self).__name__} channel_id = {self.channel_id}, title = {reprlib.repr(self.title)}>'
