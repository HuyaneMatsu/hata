...
from .constants import LAVALINK_KEY_STATS_UPTIME, LAVALINK_KEY_STATS_PLAYER_COUNT, \
    LAVALINK_KEY_STATS_PLAYING_PLAYER_COUNT, LAVALINK_KEY_STATS_MEMORY, LAVALINK_KEY_STATS_MEMORY_FREE, \
    LAVALINK_KEY_STATS_MEMORY_USED, LAVALINK_KEY_STATS_MEMORY_ALLOCATED, LAVALINK_KEY_STATS_MEMORY_RESERVABLE, \
    LAVALINK_KEY_STATS_CPU, LAVALINK_KEY_STATS_CPU_CORES, LAVALINK_KEY_STATS_CPU_SYSTEM_LOAD, \
    LAVALINK_KEY_STATS_CPU_LAVALINK_LOAD, LAVALINK_KEY_STATS_FRAME, LAVALINK_KEY_STATS_FRAME_SENT, \
    LAVALINK_KEY_STATS_FRAME_NULLED, LAVALINK_KEY_STATS_FRAME_DEFICIT
