...
def create_cli_file(directory_path):
    ...
    create_file(
        ...
        (
            ...
            f'    from {PACKAGE_NAME!s}.ext.plugin_loader import frame_filter, load_all_plugin, register_plugin\n'
            ...
            f'    try:\n'
            f'        load_all_plugin()\n'
            f'    except BaseException as exception:\n'
            f'        write_exception_sync(exception, filter = frame_filter)\n'
