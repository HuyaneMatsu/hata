...
setup(
    ...
    packages = [
        ...
        'hata.discord.channel.channel.channel_type',
        'hata.discord.channel.channel.metadata',
        'hata.discord.channel.forum_tag',
        'hata.discord.client',
        'hata.discord.client.compounds',
        'hata.discord.component',
        'hata.discord.component.component',
        'hata.discord.component.component.component_type',
        'hata.discord.component.component.metadata',
        ...
        'hata.discord.integration.integration.integration_type',
        'hata.discord.integration.integration.metadata',
